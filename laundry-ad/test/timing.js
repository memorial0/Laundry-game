 ...
 *   watch      28.0초 고정      (장면 1·2·3·4·10)
 *   intervene  45.15초 고정(되감기 6초 포함) + 되돌리기 대기 + 장면 6 조작 시간
 *
 *   장면 길이는 게임 자극과의 노출 시간 대칭이 정한다(scenes.js 의 DUR 표).
 *   나래이션 클립 + 0.3초는 그 하한이다.
 ...
 *   6 — 시트를 넣을 때까지 대기 */
const DUR = { 1: 4.0, 2: 2.6, 3: 6.0, 4: 3.6, 11: 3.8, 5: null, 6: null, 7: 3.9, 8: 3.25, 9: 4.0, 10: 8.0 };
const PLAYLIST = { watch: [1, 2, 3, 4, 11, 10], intervene: [1, 2, 3, 4, 11, 5, 6, 7, 8, 9, 10] };
