...
(function () {
  ...
  /* bedLevel — 게임 배경음과 라우드니스를 맞추는 계수. 코어의 BED 주석 참고.
   * 이 값은 tools/bed-render.js 로 재서 정했다. 층 세기를 건드리면 다시 재야 한다. */
  window.AD_SFX = createSfx(VOICES, { muted: muted, bed: BED_VOICE, bedLevel: 1.68 });
