...
export var LOG = {
  ...
  CTA_CLICK: 0,
  /* 카드 오른쪽 위 [×]. CTA 와 짝이 되는 행동이다 — 나가는 길이 다운로드뿐이면
   * CTA_CLICK 이 "받고 싶다"가 아니라 "나가려면 이것밖에 없다"를 재게 된다.
   * 둘 다 0 이면 8초가 지나 저절로 끝난 것이다. 세탁 자극도 같은 이름으로 기록한다. */
  CLOSE_CLICK: 0,
  /* 초, 제품 카드가 뜬 뒤 누르기까지. 안 누르고 끝나면 null.
